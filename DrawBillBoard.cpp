...
void DrawBillBoard::Draw()
{
	...
	vertex[0].TexCoord = D3DXVECTOR2(m_x, m_y);

	vertex[1].Position = D3DXVECTOR3(1.0f, 1.0f, 0.0f);
	vertex[1].Normal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
	vertex[1].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[1].TexCoord = D3DXVECTOR2(m_x + corX, m_y);

	vertex[2].Position = D3DXVECTOR3(-1.0f, -1.0f, 0.0f);
	vertex[2].Normal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
	vertex[2].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[2].TexCoord = D3DXVECTOR2(m_x, m_y + corY);

	vertex[3].Position = D3DXVECTOR3(1.0f, -1.0f, 0.0f);
	vertex[3].Normal = D3DXVECTOR3(0.0f, 1.0f, 0.0f);
	vertex[3].Diffuse = D3DXVECTOR4(1.0f, 1.0f, 1.0f, 1.0f);
	vertex[3].TexCoord = D3DXVECTOR2(m_x + corX, m_y + corY);
...
void DrawBillBoard::Load(std::string filePath)
{
	VERTEX_3D vertex[4];
...
void DrawBillBoard::Load(std::string filePath, D3DXVECTOR3 size)
{
	size.z = 0.0f;
...
void DrawBillBoard::SetUV(float x, float y, float spritX, float spritY)
{
	m_x = x;
	m_y = y;
	m_spritX = spritX;
